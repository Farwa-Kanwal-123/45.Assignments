...
let guestList = ["Imran Khan", "Kamran Tessori", "Nawaz Shareef", "Zardari", "Zia Khan", "Danyal Nagori"];
console.log(`I am inviting ${guestList.length} guests to a dinner party.`);

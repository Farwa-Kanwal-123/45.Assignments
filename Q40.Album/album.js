...
// Test the function with different albums
const album1 = make_album("Artist1", "Album1");
const album2 = make_album("Artist2", "Album2", 12); // Passing number of tracks
const album3 = make_album("Artist3", "Album3", 8); // Passing number of tracks
// Print each album
console.log(album1);
console.log(album2);
console.log(album3);
